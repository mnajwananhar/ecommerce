            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
                ...
                @forelse ($sortedProducts as $product)
                    <a href="{{ route('products.show', $product->id) }}" class="block">
                        <div
                            class="bg-white rounded-lg shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden group h-full flex flex-col {{ $product->stock == 0 ? 'opacity-75' : '' }}">
                            <!-- Image Container -->
                            <div class="relative w-full h-32 sm:h-48 flex-shrink-0">
