            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4 mt-8">
                        ...
                        <div
                            ...
                            <div class="p-3">
                                ...
                                <div class="flex items-center gap-1 mb-1">
                                    ...
                                    @endif
                                    <span class="text-xs text-gray-600">{{ $product->shop->shop_name }}</span>
                                </div>
                                <!-- Nama Produk -->
                                <h3 class="text-xs font-medium text-gray-800 line-clamp-2 mb-1">
                                    {{ $product->name }}
                                </h3>
                                <!-- Badges -->
                                <div class="flex gap-1 mb-1">
                                    ...
                                    @if ($product->stock > 0)
                                        <span
                                            class="px-1.5 py-0.5 bg-green-100 text-green-800 text-[10px] font-medium rounded">
                                            {{ $product->stock }}
                                        </span>
                                    @endif
                                </div>
                ...
                @empty
                    <div class="col-span-full text-center py-12">
                        ...
                        <p class="mt-1 text-sm text-gray-500">Currently there are no products available.</p>
                    </div>
                @endforelse
            </div>
